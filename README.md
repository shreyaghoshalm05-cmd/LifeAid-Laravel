...
<h1 align="center">LifeAid – Medical & Emergency Assistance Web Application</h1>

<p align="center">
A Laravel-based healthcare and emergency support web application designed to provide quick access to hospitals, doctors, blood donors, pharmacies, labs, and first-aid information.
</p>
...
1. Clone the repository:
   ```bash
   git clone https://github.com/shreyaghoshalm05-cmd/LifeAid-Laravel.git
